...
public class Utils {
    ...
    /**
     * Calculates the middle point between two points and multiplies its coordinates with the given smoothness
     * _Mulitplier.
     * 
    ...
    /**
     * Calculates the legend positions and which legend title should be displayed or not. Important: the LegendBounds in
     * the _Models should be set and correctly calculated before this function is called!
     * 
     ...
     */
    public static void calculateLegendInformation(List<? extends BaseModel> _Models,
                                                  float _StartX,
                                                  float _EndX,
                                                  Paint _Paint) {
     ...
     * @param _Text The text which should be measured. If null, a default text is chosen, which has a maximum possible
     * height
