...
package com.compet.eazygraphexample.models;

import android.graphics.Rect;
import android.graphics.RectF;

/**
 * The BaseModel is the parent model of every chart model. It basically only holds the information about the legend
 * labels of the childs value.
 */
