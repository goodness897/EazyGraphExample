...
/**
 * This is the main chart class and should be inherited by every graph. This class provides some general methods and
 * variables, which are needed and used by every type of chart.
 */
public abstract class BaseChart extends ViewGroup {
    ...
    public BaseChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mLegendHeight = a.getDimension(R.styleable.BaseChart_egLegendHeight,
                                           Utils.dpToPx(DEF_LEGEND_HEIGHT));
    ...
    /**
     * Should be called when the dataset changed and the graph should update and redraw. Graph implementations might
     * overwrite this method to do more work than just call onDataChanged()
     */
    public void update() {
        onDataChanged();
    }
